NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$scope active alt angular api application applicationlaunchercontroller aria-expanded aria-haspopup badge button caret class classes click col-xs-12 collapse component controller custom data-toggle default directive disable display displayed dropdown dropdown-toggle enterprise fa fa-dashboard false flag function general good grid help hidden-icons hiddenicons horizontaldropdownmenu11 href html icon iconclass icons img indicator interface is-disabled is-list isdisabled islist item items johnson js label launch launcher link links list list-style-type lorem menu module nav nav-item-iconic navbar navbar-brand navbar-collapse navbar-collapse-1 navbar-default navbar-header navbar-nav navbar-pf navbar-primary navbar-utility navigate navigation navigationitems ng-controller patternfly pficon pficon-build pficon-domain pficon-help pficon-home pficon-storage-domain pficon-user pre-demo-text recteque rendering role row rule script src style suavitate svg title tooltip true user"
    },
    {
      "section": "api",
